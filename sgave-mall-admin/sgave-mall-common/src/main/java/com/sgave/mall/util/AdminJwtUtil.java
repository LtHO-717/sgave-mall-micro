...
public class AdminJwtUtil {
    ...
    // 秘钥
    static final String SECRET = "SGAVE-Mall-Admin-Token";
    // 签名是有谁生成
    static final String ISSUSER = "SGAVEMALL";
    // 签名的主题
    static final String SUBJECT = "this is SGAVEMall token";
    // 签名的观众
