...
public class AdminGoodsController {
    ...
    @Operation(summary = "同步商品到ES")
    @PutMapping("/syncES")
    Object syncAllGoodsToEs(@RequestParam("current") Integer current, @RequestParam("size") Integer size){
        return goodsService.syncAllGoodsToEs(current,size);
    }
}
